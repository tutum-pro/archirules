...
<What happens if we leave it unresolved — concretely, not "there will be problems".>

**To resolve:** <what has to be known or seen before this can be answered> — and when that
will realistically be knowable.

<!-- Closing:
**Status:** RESOLVED → ADR-NNNN, <date>
